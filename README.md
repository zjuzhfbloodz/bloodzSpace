...
1. 图片位于 `source/images/pets`（含 `archive` 子目录）。
2. 页面读取 `source/pets/images-data.js` 渲染主相册与归档页。
3. 主相册默认仅显示人物/猫咪/狗狗；归档页展示其余图片。
